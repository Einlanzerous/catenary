...
final class Conversation {
  ...
  factory Conversation.fromJson(Object? v, [String p = "Conversation"]) {
    ...
    return Conversation(
      ...
      headSeq: o["head_seq"] == null ? _bad('${p}.head_seq', 'required field is missing') : ((Object? v, String p) { final x = _int(v, p); if (x < 0) _bad(p, 'head_seq must be >= 0, got $x'); if (x > 9007199254740991) _bad(p, 'head_seq must be <= 9007199254740991, got $x'); return x; })(o["head_seq"], '${p}.head_seq'),
...
final class MessageSendRequest {
  ...
  factory MessageSendRequest.fromJson(Object? v, [String p = "MessageSendRequest"]) {
    final o = _obj(v, p);
...
final class DirectConversationRequest {
  ...
  factory DirectConversationRequest.fromJson(Object? v, [String p = "DirectConversationRequest"]) {
    final o = _obj(v, p);
    return DirectConversationRequest(
